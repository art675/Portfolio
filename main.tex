...
% Temporary internal targets.
% Move these to the actual section pages later.

\hypertarget{composites}{}
...
\node[
    ...
    {
        \hyperlink{composites}{\textbf{01 COMPOSITES}}
        \hspace{0.25in}
...
\textbf{Vision-Based Road-Following Vehicle}\\[7pt]

\textcolor{PolyGold}{\textbf{12}} \;
Autonomous Parallel-Parking System\\[7pt]

\textcolor{PolyGold}{\textbf{13}} \;
U-Net Semantic Segmentation for Road-Scene Perception\\[11pt]

{\sffamily
 \fontsize{6.7}{7.7}\selectfont
 \color{Muted}
 Perception, planning, control implementation,
 testing, and autonomous vehicle behavior.}
}
